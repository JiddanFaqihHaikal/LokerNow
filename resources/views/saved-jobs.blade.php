...
@section('content')
    <div class="px-6 py-10 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="text-black rounded-2xl p-6 relative shadow-lg aspect-square outline outline-1 outline-gray-900"
                ...
                <h2 class="inline-block bg-white text-black text-lg font-semibold mb-2 px-2 py-1 rounded">
                    Supply Chain Intern
                </h2>
            ...
            {{-- Card 2 --}}
            <div class="bg-gray-100 rounded-2xl p-6 relative shadow-sm aspect-square outline outline-1 outline-gray-900">
                <div x-data="{ loved: true, darkIcon: false }" class="absolute top-4 right-4">
                    <button @click="loved = !loved">
                        <img :src="loved
                            ?
            ...
            {{-- Card 3 --}}
            <div
                class="bg-gray-900 text-white rounded-2xl p-6 relative shadow-sm aspect-square outline outline-1 outline-gray-900">
