        ...
        <div class="max-w-7xl mx-auto">
            ...
            @if($savedJobs->isEmpty())
                <div class="bg-gray-800 text-white rounded-lg p-8 text-center">
                    ...
                    <a href="{{ route('search.jobs') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-black bg-[#B9FF66] hover:bg-[#a8e65c] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#B9FF66]">
                        Browse Jobs
                    </a>
                </div>
            @else
