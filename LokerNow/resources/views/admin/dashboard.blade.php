...
<div class="px-6 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
            <h2 class="text-sm text-gray-500 mb-1">Job Seekers</h2>
            <p class="text-2xl font-bold">{{ $totalJobSeekers ?? 0 }}</p>
        </div>
        
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
            <h2 class="text-sm text-gray-500 mb-1">Admins</h2>
            <p class="text-2xl font-bold">{{ $totalAdmins ?? 0 }}</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <a href="{{ route('admin.users') ?? '#' }}" class="block">
            <div class="bg-[#B9FF66] rounded-2xl p-4 relative h-[160px]">
